...
final class User {
    ...
    final public function UserGsad(string $sCmd, array $aVarsIn, array &$aVarsOut): bool {
        ...
        if("User.Get" == $sCmd) {
            ...
            // Get User.
            if(!$this->oDb->UserGsad("Get", $aVarsIn1, $aVarsOut1)) { /* Error */ }
            ...
            // Get User.
            if(!$this->oDb->UserGsad("Set", $aVarsIn1, $aVarsOut1)) { /* Error */ }
            ...
            // Get User.
            if(!$this->oDb->UserGsad("Add", $aVarsIn1, $aVarsOut1)) { /* Error */ }
            ...
            // Get User.
            if(!$this->oDb->UserGsad("Del", $aVarsIn1, $aVarsOut1)) { /* Error */ }
...
class UserDb extends Db {
    ...
    final public function UserGsad(string $sCmd, array $aVarsIn, array &$aVarsOut): bool {
        ...
        if("Get" == $sCmd) {
            // Init vars.
            if(empty($aVarsIn['Email']) || empty($aVarsIn['Password'])) { /* Error */ }
