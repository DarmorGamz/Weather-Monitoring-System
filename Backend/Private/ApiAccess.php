...
final class ApiAccess {
    ...
    private function DataGsad(string $sCmd) : bool {
        ...
        if($sCmd == 'Data.Get') {
            ...
            } else if ($aVarsIn['DataType'] == 10) {
                $apiUrl = 'http://api.weatherapi.com/v1/forecast.json?key=d42a68e851d7453c8d6165458230904&q=Toronto'; // Replace this with the target API URL
